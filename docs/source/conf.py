...
# -*- coding: utf-8 -*-
#
# dfttk documentation build configuration file, created by
...
# documentation.
#
#html_theme_options = {'logo': 'DFTTK-LOGO.png'}

html_logo = '_static/DFTTK-LOGO.png'
...
man_pages = [
    (master_doc, 'dfttk', 'dfttk Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dfttk', 'dfttk Documentation',
     author, 'dfttk', 'One line description of project.',
     'Miscellaneous'),
]
