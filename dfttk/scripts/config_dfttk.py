...
def add_path_var(force_override=True, **kwarg):
    ...
    if os.path.exists (bashrc):
        shutil.copyfile(bashrc, os.path.join(bashrc,".dfttk.bak"))  #backup the .bashrc file
    cshrc = os.path.join(homepath, ".cshrc")
    if os.path.exists (cshrc):
        shutil.copyfile(cshrc, os.path.join(cshrc,".dfttk.bak"))  #backup the .bashrc file
    tcshrc = os.path.join(homepath, ".tcshrc")
    if os.path.exists (tcshrc):
        shutil.copyfile(tcshrc, os.path.join(tcshrc,".dfttk.bak"))  #backup the .bashrc file
