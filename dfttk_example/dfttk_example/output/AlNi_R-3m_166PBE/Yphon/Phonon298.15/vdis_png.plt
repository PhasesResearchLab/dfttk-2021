...
set xtics ( 'D' qunit*0.000000, '{/Symbol G}' qunit*0.116065, 'Z' qunit*0.174711, 'A' qunit*0.290776, '{/Symbol G}' qunit*0.401792)

set key left top
set ylabel "Frequency (THz)"

plot [x=0:qunit*p4*1.0001] [funit*0.000000:funit*16.000000] \
