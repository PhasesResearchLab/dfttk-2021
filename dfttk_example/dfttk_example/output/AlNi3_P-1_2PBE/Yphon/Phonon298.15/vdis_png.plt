...
set xtics ( '{/Symbol G}' qunit*0.000000, 'X' qunit*0.118637, 'Y' qunit*0.254296, '{/Symbol G}' qunit*0.342171, 'Z' qunit*0.408435)

set key left top
set ylabel "Frequency (THz)"

plot [x=0:qunit*p4*1.0001] [funit*0.000000:funit*14.000000] \
